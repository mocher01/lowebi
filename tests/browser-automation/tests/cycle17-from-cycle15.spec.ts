...
test('Cycle 17: Complete Step 7 Site Generation', async ({ page, browser }) => {
  ...
  console.log('Purpose: Complete Steps 1-7 including AI content, images, and final site generation');
  console.log('Cycle 17 Goals:');
  ...
  console.log('Flow: Foundation (1-5) → Content AI (10-13) → Image AI (14b) → Step 6 → STEP 7 GENERATE');
  ...
  try {
    ...
    const siteName = `Cycle17_Step7_${timestamp}`;
    ...
    try {
      ...
      if (!generateButtonFound) {
        ...
        await page.screenshot({ path: '/tmp/cycle17-generation-complete.png', fullPage: true });
        console.log('📸 Final screenshot saved');

        console.log('\n🎉 STEP 7 SITE GENERATION TEST COMPLETED!');
      }
