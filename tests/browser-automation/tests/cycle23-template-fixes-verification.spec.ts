...
test('Cycle 23: Complete Workflow with Template Fixes Verification', async ({ page, browser }) => {
  test.setTimeout(600000); // 10 minutes timeout for complete workflow
  console.log('🔄 CYCLE 23: COMPLETE WORKFLOW WITH TEMPLATE FIXES VERIFICATION - TEST23');
  console.log('Purpose: Complete Steps 1-7 + verify template fixes (section IDs, navigation, CSS rules)');
  console.log('Cycle 23 Goals:');
  console.log('  - Complete all foundation steps (1-5)');
  console.log('  - Complete content AI workflow (Steps 10-13)');
  console.log('  - Complete image AI workflow (Step 14b) WITH color hints verification');
  console.log('  - Navigate to Step 6 (Advanced Features)');
  console.log('  - Navigate to Step 7 (Review) WITH color hints verification');
  console.log('  - GENERATE SITE and verify deployment');
  console.log('  - VERIFY colors are applied in generated site');
  console.log('  - NEW: VERIFY section IDs exist (about, services, testimonials, hero, cta)');
  console.log('  - NEW: VERIFY navigation anchor links work (footer links scroll to sections)');
  console.log('  - NEW: VERIFY UX Professional CSS rules applied (links, nav hovers, badges)');
  console.log('Flow: Foundation (1-5) → Content AI (10-13) → Image AI (14b) → Step 6 → Step 7 → Generate → Verify Template Fixes');
  ...
  try {
    // Generate site name for template fixes verification
    const siteName = `test23`;
    ...
    // ============================================================================
    // CYCLE 23: TEMPLATE FIXES VERIFICATION
    // ============================================================================
    console.log('\n🔧 CYCLE 23: TEMPLATE FIXES VERIFICATION');
    console.log('=' .repeat(80));
    ...
    // ============================================================================
    // CYCLE 23: TEMPLATE FIXES RESULTS
    // ============================================================================
    console.log('\n📊 CYCLE 23 TEMPLATE FIXES RESULTS:');
    ...
    if (templateFixesPassed === templateFixesTotal) {
      console.log('\n🎉 🎉 🎉 CYCLE 23 TEMPLATE FIXES: ALL TESTS PASSED! 🎉 🎉 🎉');
      ...
      console.log('\n✅ CYCLE 23 SUCCESS: Template fixes mostly working');
      console.log(`📊 Passed: ${templateFixesPassed}/${templateFixesTotal} tests`);
    } else {
      console.log('\n⚠️ CYCLE 23 PARTIAL: Template fixes need attention');
      console.log(`📊 Passed: ${templateFixesPassed}/${templateFixesTotal} tests`);
    }
