...
test('Cycle 14b V1.7: Complete AI Workflow - With Blog Image Validation', async ({ page, browser }) => {
  console.log('🔄 CYCLE 14b V1.7: COMPLETE AI WORKFLOW - WITH BLOG IMAGE VALIDATION');
  ...
  try {
    ...
    const siteName = `Cycle14b_V1.7_${timestamp}`;
