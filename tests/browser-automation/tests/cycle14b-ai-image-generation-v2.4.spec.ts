...
test('Cycle 14b V2.4: Bug Fixes - Admin Fields + Blog Persistence', async ({ page, browser }) => {
  test.setTimeout(600000); // 10 minutes timeout for complete workflow
  console.log('🔄 CYCLE 14b V2.4: BUG FIXES - ADMIN FIELDS + BLOG PERSISTENCE');
  console.log('Purpose: Verify Bug #2 and Bug #3 fixes from manual testing');
  console.log('V2.4 Fixes:');
  console.log('  - Bug #2: Admin does NOT show "Image Blog", "Image À propos", "Image Contact"');
  console.log('  - Bug #3: Blog article image fields persist after admin processing');
  console.log('  - All previous V2.3 features still working');
  console.log('Flow: Foundation (1-6) → Content AI (10-13) → Image AI (14b) → ADMIN VALIDATION → STEP 5 VERIFICATION');
  ...
  try {
    ...
    const siteName = `Cycle14b_V2.4_${timestamp}`;
