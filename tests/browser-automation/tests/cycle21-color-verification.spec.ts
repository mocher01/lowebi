...
test('Cycle 21: Complete Workflow with Color Verification', async ({ page, browser }) => {
  test.setTimeout(600000); // 10 minutes timeout for complete workflow
  console.log('🔄 CYCLE 21: COMPLETE WORKFLOW WITH COLOR VERIFICATION');
  console.log('Purpose: Complete Steps 1-7 with color hints verification and color application verification');
  console.log('Cycle 21 Goals:');
  ...
  console.log('Flow: Foundation (1-5) → Content AI (10-13) → Image AI (14b + color hints) → Step 6 → Step 7 (color hints) → Generate → Verify Colors');
  ...
  try {
    // Generate site name with color validation
    const siteName = `test20-color-check`;
