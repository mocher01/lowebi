...
test('Cycle 24: Complete Workflow with Secondary Color Verification', async ({ page, browser }) => {
  test.setTimeout(600000); // 10 minutes timeout for complete workflow
  console.log('🔄 CYCLE 24: COMPLETE WORKFLOW WITH SECONDARY COLOR VERIFICATION - TEST24');
  console.log('Purpose: Complete Steps 1-7 + verify secondary color usage (60-30-10 rule)');
  console.log('Cycle 24 Goals:');
  ...
  console.log('  - NEW: VERIFY secondary color is used in service cards hover gradient');
  console.log('  - NEW: VERIFY secondary color is used in stats cards (About section)');
  console.log('  - NEW: VERIFY secondary color is used in testimonial cards');
  console.log('  - NEW: VERIFY accent color lightness validation (>70% auto-adjusted to 60%)');
  console.log('Flow: Foundation (1-5) → Content AI (10-13) → Image AI (14b) → Step 6 → Step 7 → Generate → Verify Secondary Colors');
