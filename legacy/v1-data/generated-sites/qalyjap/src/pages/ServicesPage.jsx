...
const ServicesPage = () => {
  ...
  // 🎨 Header style configurable avec nouvelles options courses
  const coursesSection = config.sections?.courses || {};
  const headerBackgroundStyle = {
    background: coursesSection.titleBackground || designConfig.background?.color || primaryColor
  };
  
  const headerTitleColor = coursesSection.titleTextColor || designConfig.title?.color || primaryColor;
  const headerSubtitleColor = coursesSection.subtitleTextColor || designConfig.subtitle?.color || '#374151';
