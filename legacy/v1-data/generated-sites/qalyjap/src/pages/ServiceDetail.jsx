      ...
      <div className="bg-gray-50 py-4 border-b">
        <div className="container">
          <nav className="flex items-center space-x-2 text-sm">
            ...
            <Link to="/services" className="text-gray-600 hover:text-gray-900">Activités</Link>
            <span className="text-gray-400">/</span>
              ...
              >
                ...
                <div className="p-6 bg-white border-2 border-gray-100 rounded-xl shadow-sm">
                  ...
                  <p className="text-gray-700 mb-4 italic leading-relaxed">
                    ...
                    et l'ambiance très chaleureuse. Je recommande vivement cette activité à tous ceux 
      ...
      >
        <div className="container text-center">
          ...
          <p className="text-xl mb-8 max-w-2xl mx-auto text-gray-600">
            Contactez-nous dès aujourd'hui pour réserver votre cours d'essai gratuit 
            et découvrir votre nouvelle passion.
          </p>
