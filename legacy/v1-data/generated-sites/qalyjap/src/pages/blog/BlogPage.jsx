...
const BlogPage = () => {
  ...
  // 🎨 Header style configurable avec nouvelles options blog
  const headerBackgroundStyle = {
    background: blogSection.titleBackground || designConfig.background?.color || primaryColor
  };
  
  const headerTitleColor = blogSection.titleTextColor || designConfig.title?.color || primaryColor;
  const headerSubtitleColor = blogSection.subtitleTextColor || designConfig.subtitle?.color || '#374151';
