...
const AboutPage = () => {
  ...
  return (
    <>
      ...
      <section className="about-header section-about">
              ...
              <div className="grid grid-cols-2 gap-4">
                {defaultStats.map((stat, index) => (
                  <div 
                    ...
                    style={{ backgroundColor: aboutSection.cardBackground || '#ffffff' }}
                  >
      ...
      {values.length > 0 && (
        <section 
          className="py-20"
          style={{ backgroundColor: config.sections?.values?.background || aboutSection.background || '#f8fafc' }}
        >
          <div className="container">
            <div className="text-center mb-16">
              <h2 
                className="text-3xl md:text-4xl font-bold mb-4"
                style={{ color: config.sections?.values?.textColor || sectionTextColor }}
              >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {values.map((value, index) => (
                <motion.div
                  ...
                  style={{ backgroundColor: config.sections?.values?.cardBackground || '#ffffff' }}
                >
                  <h3 
      ...
      >
        <div className="container text-center">
          ...
          <p 
            ...
            style={{ color: config.sections?.cta?.textColor || sectionTextColor }}
          >
